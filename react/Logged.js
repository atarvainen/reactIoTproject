...
function barChart(props) {
    return (
        <BarChart data={this.state.data} title="Bar" legendPosition="bottom"/>
    );
}

function doughnutChart(props) {
    return (
        <DoughnutChart data={this.state.data} title="Donitsi" legendPosition="bottom"/>
    );
}

function lineChart(props) {
    return (
        <LineChart data={this.state.data} title="Line" legendPosition="bottom"/>
    );
}
